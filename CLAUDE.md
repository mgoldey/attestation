...
|evals:{tagging_eval.py,run_tagging_eval.py,optimize_tagging.py,transfer_matrix.py,tagging_cases.json,prompts/}|examples:{README.md,workspace/}|examples/flows:{README.md,RESULTS.md,run_all.py,persona_eval.py,mcp_e2e.py,stub_openai.py,_common.py,corpus/}|examples/flows/training:{train_mlflow.py,FINDINGS.md,mlruns/}
