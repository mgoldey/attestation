...
|docs:{recommendation-refinements.md}
...
|Storage: db.py SQLite + sqlite-vec|tables: users,feeds,items,clicks,explanations,item_features,item_tags,kg_nodes,kg_edges,kg_meta,runs,run_metrics
