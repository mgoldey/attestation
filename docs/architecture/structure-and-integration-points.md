...
| The skill | `src/attestation/skills/research-provenance/SKILL.md` — how an agent should behave with the tools (never ask for a persona name; extract verdicts from discourse) | hermes-agent, Claude Code | `tests/test_skill_files.py` | `docs/guides/agents.md` |
